...
class ProductRequestEdit extends StatefulWidget {
  ...
  ProductRequestEdit({Key key, this.product,}) : super(key: key);
    ...
    Future getImage() async {
     ...
     return Scaffold(
       appBar: AppBar(
         ...
         title: Text("Product Request Edit"),
       ),
      body: ListView(
          children: <Widget>[
    ...
    return
      Column(
        ...
        children: <Widget>[
          ...
          TextFormField(
              obscureText: false,
              initialValue:widget.product.name !=null ? widget.product.name :'',
              decoration: InputDecoration(
                  border: InputBorder.none,
                  fillColor: Color(0xfff3f3f4),
                  filled: true),
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              TextFormField(
                  obscureText: false,
                  initialValue:widget.product.description !=null ? widget.product.description :'',
