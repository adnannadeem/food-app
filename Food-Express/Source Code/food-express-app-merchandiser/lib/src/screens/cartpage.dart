                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      model.updateProduct(model.cart[index].id,model.cart[index].price,
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      (model.cart[index].qty).toString(),
                                      style:
                                      CustomTextStyle.textFormFieldBlack,
                                    ),
                                  ),
                                    IconButton(
