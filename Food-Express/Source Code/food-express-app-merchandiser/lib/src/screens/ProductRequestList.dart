...
import 'package:foodshopapp/src/screens/ProductEdit.dart';
import 'package:foodshopapp/src/screens/ProductPage.dart';
import 'package:foodshopapp/src/screens/ProductPost.dart';
import 'package:foodshopapp/src/screens/ProductRequestEdit.dart';
  ...
  Future<String> getProducts(String shopID) async {
    ...
    if (response.statusCode == 200) {
      setState(() {
        ...
        _listProduct.forEach((element) => _products.add(Product(name: element['name'], id: element['id'], imgUrl: element['image'],categories: element['categories'],categoriesID:element['categoriesID'],description: element['description'], price: element['unit_price'].toDouble())));
      });
    } else {
                  ...
                  IconSlideAction(
                    ...
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => ProductRequestEdit(product: _products[index],),
                      ));
                    },
                  ),
                  IconSlideAction(
