...
import 'package:foodshopapp/src/screens/otpNumberPage.dart';
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Consumer<AuthProvider>(
            builder: (context, provider, child) => provider.notification ?? NotificationText('This user data not found'),
          ),
          actions: <Widget>[
            FlatButton(
              child: Text('Ok'),
