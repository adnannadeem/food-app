    ...
    if (response.statusCode == 200) {
      setState(() {
        ...
        _listProduct.forEach((element) {
          _products.add(Product( variations:element['variations'],options:element['options'], name: element['product']['name'], id: element['product']['id'],productItemID:element['id'], imgUrl: element['product']['image'],quantity: element['quantity'] , price: element['unit_price'].toDouble()));
        });
      });
    } else {
                  ...
                  IconSlideAction(
                    ...
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => ProductEdit(product: _products[index],),
                      ));
                    },
                  ),
                  IconSlideAction(
