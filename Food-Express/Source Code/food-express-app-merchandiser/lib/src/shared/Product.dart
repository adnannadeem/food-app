class Product {
  ...
  Product({this.options,this.variations,this.in_stock,this.stock_count,this.id, this.name,this.productItemID, this.price, this.categories,this.categoriesID,this.description,this.qty,this.quantity, this.imgUrl});
}
